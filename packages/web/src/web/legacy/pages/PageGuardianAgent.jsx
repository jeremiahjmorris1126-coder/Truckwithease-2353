...
const CRITICAL_PAGES = [
  ...
  { id: "dispatch", path: "/dispatch", label: "Dispatch", icon: "🚛", desc: "Mission control — must show live map, load board, and intelligence optimization", checks: ["Page loads", "6 tabs render", "Fleet AI runs", "Road alerts fire", "Broker check works"] },
