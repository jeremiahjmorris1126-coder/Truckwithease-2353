...
const PLANS = {
  ...
  pro: {
    ...
    features: ['Everything in Solo', 'Quantum Dispatch', 'Factoring Integration', 'Toll Optimizer', 'Weigh Station Bypass', 'Voice Commands', 'Advanced Reports', 'Detention Tracker', 'Permit Book', 'Priority Support'],
    quickstart: [
      ...
      { step: 2, title: 'Try Quantum Dispatch', desc: 'Tap Dispatch → your best load matches are already pre-staged. Tap a load, review the profit breakdown, tap Assign to Me.', link: '/dispatch' },
    ...
    faq: [
      { q: 'How does Quantum Dispatch work?', a: 'It pre-matches loads to you based on your location, HOS hours, CDL class, and equipment — automatically, before you even open the app. Just review and confirm.' },
  ...
  fleet_owned: {
    ...
    features: ['Everything in Fleet Rental', 'HRease Hiring & Onboarding', 'Background Checks', 'Quantum Dispatch Full', 'Ghost Nerve Intelligence', 'Payroll from ELD Miles', 'Game Up Training', 'AI Dashcam Integration', 'Insurance Savings Program', 'White-Label Option'],
    quickstart: [
...
const ALL_FEATURES = [
  ...
  { name: 'Quantum Dispatch', path: '/dispatch', desc: 'AI pre-matches loads to drivers. 12 intelligence layers. Zero clicks required.', plans: ['pro','fleet_rental','fleet_owned'] },
