...
const MODES = {
  truck: {
    ...
    description: 'The complete platform for professional truck drivers, owner-operators, and fleet managers. Intelligence dispatch, FMCSA compliance, payroll from ELD miles, and Ghost Nerve AI — all in one place.',
    color: '#F5A623',
